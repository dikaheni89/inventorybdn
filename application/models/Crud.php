...
class Crud extends CI_Model
{
    ...
    public function get_where_or($table, $qr)
    {
        $this->db->order_by("id", "DESC");
        $this->db->or_where("mac", $qr);
        $this->db->or_where("sn", $qr);
        $this->db->or_where("kode_assets", $qr);
    ...
    public function get_all_limit_asc($table)
    {
    ...
    public function get_all_limit_jml($table, $jml)
    {
        $this->db->order_by("id", "DESC");
        $this->db->limit($jml);
        return $this->db->get($table);
