                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="<?= base_url('dashboard/purchase_order') ?>" type="button" class="btn btn-danger">
                            ...
                            <table id="table-user" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-ordering="false">Harga<br>(Rp)</th>
                                        <th data-ordering="false">Amount<br>(Rp)</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
...
<script>
    ...
    $(function() {
        $("#table-user").DataTable({
            ...
            'ajax': {
                'dataType': 'json',
                'url': '<?= base_url() ?>dashboard/ajax_table_po_list',
                'type': 'post',
                'data': {
                    po_no: '<?= $_GET["po_no"] ?>'
                }
