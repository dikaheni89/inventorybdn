    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">log Aktivitas</h4>
            ...
            <div class="alert alert-primary" role="alert">
                <strong>Info :</strong> Halaman ini digunakan untuk melihat histori aktivitas di sistem!
            </div>
                            ...
                            <table id="table-user" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-ordering="false">Aktivitas</th>
                                        <th data-ordering="false">Nama</th>
                                        <th data-ordering="false">UserID</th>
                                        <th data-ordering="false">IP Address</th>
                                        <th data-ordering="false">Waktu</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
...
<script>
    ...
    $(function() {
        $("#table-user").DataTable({
            ...
            'ajax': {
                'dataType': 'json',
                'url': '<?= base_url() ?>dashboard/ajax_table_log',
                'type': 'post',
            },
            'columns': [{
                "target": [<?= $target ?>],
