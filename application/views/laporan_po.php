                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h5 class="card-title mb-0">Laporan Purchase Order</h5>
                        </div>
                        <div class="card-body">
                            <form id="form-data">
                                <div class="row g-3">
...
<script>
    $('#btn_download_excel').on('click', function() {
        ...
        $("#btn_download_excel").attr("href", "<?= base_url('dashboard/generatedatapo') ?>?tanggal_awal=" + awal + "&tanggal_akhir=" + akhir)
    });
</script>